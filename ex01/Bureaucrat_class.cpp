...
/*   Updated: 2024/12/27 14:55:32 by fcoullou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		Bureaucrat::signForm(Form &form)
{
	...
	{
		form.beSigned(*this);
		std::cout << YELLOW << "@  by : " << this->_name << RESET << std::endl;
	}
	else
	{
		std::cout << YELLOW << " @  " << this->_name << RED << "  cannot sign " << GREEN << form.getName() << RED << " because grade is too low" << RESET << std::endl;
	}
}
